...
public final class ParentAttackerGoal implements Goal<Mob> {
    private final Mob mob;
    private final GoalKey<Mob> key;
    private LivingEntity target;

    public ParentAttackerGoal(Mob mob) {
        this.mob = mob;
        this.key = GoalKey.of(Mob.class, NamespacedKey.fromString("mmo_mobs:parent_attacker"));
    }
    ...
    public boolean shouldActivate() {
        ...
        LivingEntity attacker = parent.getLastDamageCause() != null ? parent.getKiller() : null;
        if (attacker == null) {
            if (parent.getLastDamageCause() instanceof org.bukkit.event.entity.EntityDamageByEntityEvent event) {
